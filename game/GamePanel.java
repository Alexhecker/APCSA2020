...
public class GamePanel extends JPanel implements Runnable, KeyListener {
	...
	public void render(Graphics2D g2d){
		...
		apple.render(g2d);
		if(gameover){
			g2d.drawString("GameOver!" + "  Highest Level: " + "2", 150, 200);
		}
		
		g2d.setColor(Color.WHITE);
		g2d.drawString("Score : " + score + " Level : " + level, 10, 10);
		if(dx == 0 && dy == 0){
			g2d.drawString("Alexander Hecker", 150, 300);
			g2d.drawString("Press any arrow keys to start and play", 100, 280);
			g2d.drawString("Snake Mini-Game", 150, 260);
		}
	}
}
