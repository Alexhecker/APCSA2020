...
public class Variables
{
	public static void main ( String[] args )
	{
		...
		//decimal variables
		double doubleOne = 38.5678;
		double doubleTwo = 923.234;
		...
		System.out.println("*                               *");
		System.out.println("*32 bit - floatOne = "+doubleOne+ "\t*");
		System.out.println("*32 bit - floatOne = "+doubleTwo+ "\t*");
		System.out.println("*                               *");
		...
		System.out.println("*                               *");
		System.out.println("*booleanOne = true "+booleanOne+" \t*");
